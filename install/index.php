  ...
  <input class="form-control input-lg" name="user" placeholder="Envato Username" type="text" ><br>
  <input class="form-control input-lg" name="code" placeholder="Purchase Code" type="text" ><br>
  <hr style="background: #777; height: 1px;">
